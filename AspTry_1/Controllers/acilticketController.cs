...
{
    public class acilticketController : Controller
    {
        // GET: acilticket
        DatabaseDBEntities4 datas = new DatabaseDBEntities4();

        public ActionResult hizliticket()
        {
            return View();
        }

        [HttpPost]
        public ActionResult hizliticket(FormCollection form)
        {
            ...
            return  RedirectToAction("hizliticket", "acilticket");
